...
class Detector():
    def __init__(self, device, confidence_threshold=0.02, nms_threshold=0.4):

        self.net = RetinaFace(cfg=cfg_re50, phase = 'test')    
        pretrained_path = './weights/Resnet50_Final.pth'
        self.net = load_model(self.net, pretrained_path)
        self.net.eval()
